# Programa simple para la deteccion de ojos en tiempo real
# Importación biblioteca
import cv2

# Cargar el clasificador de cascada de Haar para detección de ojos
face_classifier = cv2.CascadeClassifier('C:/Users/Edwin/Desktop/haarcascade_eye.xml')
...
while True:
    # Esta línea captura un cuadro de la camara web
    # y lo almacena en la variable "img"
    ...
    # El título "Captura Eye" se dibuja en la imagen en la posición (10, 25)
